...
>
    ...
    <p class="relative text-sm font-semibold uppercase tracking-[0.22em] text-mint" x-text="business"></p>
    <h1 class="relative mt-4 font-display text-4xl font-semibold sm:text-6xl lg:text-7xl" x-text="name"></h1>
